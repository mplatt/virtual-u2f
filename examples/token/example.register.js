...
var registrationExample = function() {
	...
	return getResponse(PUBLIC_KEY, KEY_HANDLE, ATTESTATION_CERT, signString(PRIVATE_ATTESTATION_KEY, getSignatureBaseString(sha256Digest(APPLICATION_ID), sha256Digest(CLIENT_DATA), KEY_HANDLE, PUBLIC_KEY)));
};